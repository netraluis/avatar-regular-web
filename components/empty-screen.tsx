        ...
        <div>
          ...
          <div className="ml-12 mt-3.5 flex mb-5 ">
            <div className="w-full">
              <p>
                Sóc l’Esteve, una assistent d’intel·ligència artificial (IA){" "}
              </p>
              <br />
              <p>
                Creada especialment per ajudar a respondre i aclarir qualsevol
                dubte o consulta dels ciutadans de la Parròquia d’Andorra la
                Vella.{" "}
              </p>
              <br />
